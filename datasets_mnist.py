...
# -*- coding: utf-8 -*-
#####################################
# File name : datasets_mnist.py
# Create date : 2018-02-11 02:03
# Modified date : 2018-02-28 21:34
# Author : DARREN
# Describe : not set
...
#  TEST_LABELS = 't10k-labels-idx1-ubyte.gz'
  ...
  local_file = os.path.join('./MNIST_data','train-images-idx3-ubyte.gz')
  with open(local_file, 'rb') as f:
    train_images = extract_images(f)

  #local_file = os.path.join('datasets','train-labels-idx1-ubyte.gz')
  local_file = os.path.join('./MNIST_data','train-labels-idx1-ubyte.gz')
  with open(local_file, 'rb') as f:
    train_labels = extract_labels(f, one_hot=one_hot)

  #local_file = os.path.join('datasets','t10k-images-idx3-ubyte.gz')
  local_file = os.path.join('./MNIST_data','t10k-images-idx3-ubyte.gz')
  with open(local_file, 'rb') as f:
    test_images = extract_images(f)

  #local_file =os.path.join('datasets','t10k-labels-idx1-ubyte.gz')
  local_file =os.path.join('./MNIST_data','t10k-labels-idx1-ubyte.gz')
  with open(local_file, 'rb') as f:
